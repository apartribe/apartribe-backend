...
//    private List<CommentRes> children = new ArrayList<>();
//
//    public CommentRes(Long id, String content, Integer liked, boolean memberLiked, LocalDateTime createdAt, String createdBy) {
//        this.id = id;
//        this.content = content;
//        this.liked = liked;
//        this.memberLiked = memberLiked;
...
//    }
//
//    public static CommentRes from(CommentLiked commentLiked) {
//        Comment comment = commentLiked.getComment();
//        Member member = commentLiked.getMember();
//        return new CommentRes(
//                comment.getId(),
//                comment.getContent(),
//                comment.getLiked(),
